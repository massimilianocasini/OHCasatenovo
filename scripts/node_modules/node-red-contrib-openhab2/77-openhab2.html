...
<script type="text/x-red" data-template-name="openhab2-in">
    <style type="text/css">
        .btn-group {
            width: 70%;
        }
...
<script type="text/x-red" data-template-name="openhab2-get">
    <style type="text/css">
        .btn-group {
            width: 70%;
        }
...
<script type="text/x-red" data-template-name="openhab2-monitor">
    <div class="form-row">
        <label for="node-input-name"><i class="fa fa-tag"></i> Name</label>
        <input type="text" id="node-input-name" placeholder="Name">
    </div>
...
<script type="text/x-red" data-template-name="openhab2-out">
    <style type="text/css">
        .btn-group {
            width: 70%;
        }
...
<script type="text/x-red" data-template-name="openhab2-events">
    <div class="form-row">
        <label for="node-input-name"><i class="fa fa-tag"></i> Name</label>
        <input type="text" id="node-input-name" placeholder="Name">
    </div>
...
<script type="text/x-red" data-help-name="openhab2-controller">
...
<script type="text/x-red" data-help-name="openhab2-in">
    ...
    <ul>
        ...
        <li>Channel 2 :
			<ul>
        		...
        		<li><code>msg.payload</code> : raw (unprocessed) event for the selected item</li>
  	 		</ul>
		</li>
...
<script type="text/x-red" data-help-name="openhab2-get">
    <p>Gets an openHAB Item on an input message.</p>
	<p></p>
	<b>Configuration</b>
    <ul>
        <li><b>Name :</b> Optionally specify a name</li>
...
<script type="text/x-red" data-help-name="openhab2-monitor">
    <p>Monitors the openhab2-controller node.</p>
	<p></p>
	<b>Configuration</b>
    <ul>
        <li><b>Name :</b> Optionally specify a name</li>
	...
	<p></p>
	<b>Messages accepted by NodeRED flows</b>
    <ul>
        <li><code>msg.item</code> optionally the Item to address</li>
   	</ul>

	<b>Messages injected in NodeRED flows (3 channels)</b>
    ...
    <ul>
        ...
        <li>Channel 2 :
			<ul>
        		...
        		<li><code>msg.payload</code> : error message</li>
  	 		</ul>
		</li>
        <li>Channel 3 :
			<ul>
...
<script type="text/x-red" data-help-name="openhab2-out">
    <p>Sends commands or state updates to a selected openHAB Item.</p>
    <p>E.g. "ON", "OFF", "REFRESH", ... </p>
	<p></p>
	<b>Configuration</b>
    <ul>
        <li><b>Name :</b> Optionally specify a name</li>
	...
	<b>Messages injected in NodeRED flows (1 channels)</b>

    <ul>
        <li>Channel 1 : if successful, the input message is copied to this channel
		</li>

</script>

<script type="text/x-red" data-help-name="openhab2-events">
...
<script type="text/javascript">
	RED.nodes.registerType('openhab2-controller', {
		category: 'config',
		defaults: {
        ...
        paletteLabel: "openhab2-controller",
		label: function() {
			return this.name;
		}
	});
                ...
                $.getJSON("openhab2/items", config)
                  .done( function(data) {
                     ...
                     items.sort(function(a,b) {
                        ...
                        if (allowEmpty)
                            itemSelectionEl.append('<option value="">[No item]</option>');
                  ...
                  .fail(function(e1, e2, e3) {
                      //itemSelectionEl.append('<option value="' + 1 + '">' + e1 + '</option>');
                      //itemSelectionEl.append('<option value="' + 2 + '">' + e2 + '</option>');
                      //itemSelectionEl.append('<option value="' + 3 + '">' + e3 + '</option>');
...
<script type="text/javascript">
    ...
    RED.nodes.registerType('openhab2-in', {
        category: 'home automation',
        color: '#00cc00',
        defaults: {
            name:      {value:""},
		    controller:  {value:"", type:"openhab2-controller", required:true},
		    itemname:  {value:"", required:true},
        },
        inputs: 0,
        outputs: 2,
        icon: "node-red-contrib-openhab2.png",
        paletteLabel: "openhab2-in",
        label: function() {
...
<script type="text/javascript">
    RED.nodes.registerType('openhab2-get',{
        category: 'home automation',
        color: '#00cc00',
        defaults: {
            name:      {value:""},
...
<script type="text/javascript">
    RED.nodes.registerType('openhab2-monitor',{
        category: 'home automation',
        color: '#00cc00',
        defaults: {
            name:      {value:""},
...
<script type="text/javascript">
    RED.nodes.registerType('openhab2-out',{
        category: 'home automation',
        color: '#00cc00',
        defaults: {
            name:      {value:""},
...
<script type="text/javascript">
    RED.nodes.registerType('openhab2-events',{
        category: 'home automation',
        color: '#0fdd0f',
        defaults: {
            name:      {value:""},
        ...
        outputs: 1,
        icon: "node-red-contrib-openhab2.png",
        paletteLabel: "openhab2-events",
        label: function() {

            return(this.name||this.itemname||"openhab2 events");
        },
        oneditprepare: function() {
        	//openhabEditPrepare(this, true);
        }
