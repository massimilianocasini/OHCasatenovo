...
const char* MQTT_SERVER = "ohcasatenovo"; // Test  mosquitto server (remove xxxx.).
...
// MQTT topics
const char* TOPIC_INFO_OPTOIN = "/KMP/ProDinoWiFi/optoin";
const char* TOPIC_INFO_RELE = "/KMP/ProDinoWiFi/rele";
const char* TOPIC_INFO_DHT_T = "/KMP/ProDinoWiFi/dhtt";
const char* TOPIC_INFO_DHT_H = "/KMP/ProDinoWiFi/dhth";
